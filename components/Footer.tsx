  ...
  return (
    <footer className="relative overflow-hidden bg-paper">
      ...
      <div className="mx-auto max-w-site px-6 md:px-10">
        <div className="flex flex-col gap-3 border-t border-black/10 py-8 md:flex-row md:items-center md:justify-between md:py-10">
      ...
      {/* Oversized closing wordmark, clipped at the baseline like the original */}
